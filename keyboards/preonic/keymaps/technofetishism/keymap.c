 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | LAlt | GUI  | Del  |Lower |    Space    |Raise | GUI  | RAlt | RCtrl|Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LALT, KC_LGUI, KC_DEL, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_RGUI, KC_RALT, KC_RCTL, KC_ENT
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | LAlt | GUI  | Del  |Lower |    Space    |Raise |      | RAlt | RCtrl|Enter |
 * `-----------------------------------------------------------------------------------'
 */
